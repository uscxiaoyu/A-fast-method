...
class Bass_Estimate:
    ...
    def jacob(self, params):
        ...
        return np.array([p_1, q_1, m_1], dtype=np.float64)
    ...
    def hessian(self, params):
        ...
        return np.array([[p_2, p_q, p_m],
                         [p_q, q_2, q_m],
                         [p_m, q_m, m_2]], dtype=np.float64)
    ...
    def optima_search(self, ini_values, tol=1e-6):
        ...
        while True:
            ...
            upd = np.dot(inv_hes, jac)
            ini_values = ini_values - upd
